...
export interface Item {
  state: number; // 0 nessun problema // 1 problema // 2 problema risolto
  id: string;
  hour: number;
...
export class UseCaseDetailsComponent {
  ...
  columnsToDisplay = ['state', 'id', 'hour', 'problemsFound'];
